...
#pragma warning restore 0618 // Type or member is obsolete
        ...
        public static string SearchField(Rect rect, string searchText, bool forceFocus = false, string controlName = "SirenixSearchField")
        {
            ...
            var ignore = Event.current.type == EventType.Used;
            ...
            else if (ignoreNextLetterInSearchFIeld && GUI.GetNameOfFocusedControl() == controlName)
            {
        ...
        /// </summary>
        internal static Rect GetFeatureRichControlRect(GUIContent label, out int controlId, out bool hasKeyboardFocus, out Rect valueRect)
        {
            return GetFeatureRichControlRect(label, 0, out controlId, out hasKeyboardFocus, out valueRect);
        }

        /// <summary>
        /// Gets the feature rich control rect.
        /// </summary>
        internal static Rect GetFeatureRichControlRect(GUIContent label, int height, out int controlId, out bool hasFocus, out Rect valueRect)
        {
            Rect totalRect;
            ...
            {
                valueRect = EditorGUILayout.GetControlRect(label != null, height);
            }
        ...
        /// Gets the feature rich control rect.
        /// </summary>
        internal static Rect FeatureRichPrefixLabel(Rect rect, GUIContent label, out int controlId, out bool hasFocus)
        {
            controlId = GUIUtility.GetControlID(FocusType.Keyboard);
